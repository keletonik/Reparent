...
export const crisisContacts: CrisisContact[] = [
  {
    ...
    services: [
      ...
      },
      {
        name: '13YARN',
        phone: '13 92 76',
        description: 'Crisis support for Aboriginal and Torres Strait Islander peoples, by Aboriginal and Torres Strait Islander peoples',
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        phone: '0800 068 4141',
        description: 'Prevention of young suicide (under 35). Call, text 07860039967, or email pat@papyrus-uk.org',
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        description: '24/7 crisis support for LGBTQ+ young people. Text START to 678-678 or chat at TheTrevorProject.org',
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        description: '24/7 counselling for young people. Text CONNECT to 686868',
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        name: '1737',
        phone: '1737',
        description: 'Free call or text for mental health support anytime',
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        name: 'Pieta House',
        phone: '1800 247 247',
        description: 'Free therapy for self-harm, suicidal ideation, and bereavement. Text HELP to 51444',
      ...
      },
      {
        ...
        phone: '1800 341 900',
        description: '24hr National Freephone Helpline for women experiencing domestic abuse',
...
export const groundingExercises = [
  ...
  },
  {
    ...
    description: 'An evidence-based grounding technique used in EMDR and trauma therapy to create an internal sense of safety.',
    steps: [
      'Close your eyes or soften your gaze',
      'Imagine a place where you feel completely safe — it can be real or imagined',
      'Notice what you see in this place: colours, light, shapes',
      'Notice what you hear: sounds, silence, nature',
      'Notice what you feel: temperature, textures, the ground beneath you',
      'Let your body settle into the feeling of safety',
      'When you are ready, take 3 slow breaths and gently return',
    ],
  },
]
